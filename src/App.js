...
class App extends Component {
  ...
  componentDidMount(){
    ...
    to_about[0].addEventListener('click', ()=> smoothScroll(about, 300,
    'easeOutQuad',));
    to_skills[0].addEventListener('click', ()=> smoothScroll(skills, 300,
      'easeOutQuad',));
    to_projects[0].addEventListener('click', ()=> smoothScroll(projects, 300,
      'easeOutQuad',));
    to_contact[0].addEventListener('click', ()=> smoothScroll(contact, 300,
      'easeOutQuad',));
