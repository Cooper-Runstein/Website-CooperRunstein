...
class Projects extends React.Component {
      ...
      projects: [
        {
          ...
          desciription:
            "This is a Single Page Application ceated as a mock website when I was learning CSS, I modified it when learning React Router."
        },
        {
          ...
          desciription:
            "This project uses the mySportsFeed API to get NBA player's statistics and compare them to other players. The project is one of the first I built with React that wasn't following a tutorial. As of Aug 21, 2018, the API has changed and searches don't work. They'll be back soon."
        },
        {
          ...
          desciription:
            "This project uses the mySportsFeed API to get MLB player data. It was also one of the first projects I used CSS transitions and transforms in for more than a single feature. As of Aug 21, 2018, the API has changed and searches don't work. They'll be back soon."
        },
        {
          name: "Django Project",
        ...
        },
        {
          ...
          src:
            "https://bitbucket.org/spotcheckparkingsolutions/admin-tools/src/master/",
          desciription:
            "A set of administration tools to change the status of remote raspberry pi clients that run moterized vehicle detecion nueral networks. Uses the React Context API, React Router, and JSON web tokens to create a secure system for parking detection administration."
        },
        {
          ...
          desciription:
            "Uses Beautiful Soup to get Team Abbreviations, and Requests to make calls to an API allowing a user to compare the best players on different teams and positions."
        },
        {
          ...
          desciription:
            "A practice project using Laravel and Eloquent, in progress."
        },
        {
          name: "React Project",
          ...
          desciription:
            "In progress application that creates a chart extending from now unitl a given retirement day with one's financial status."
        },
        {
          ...
          desciription:
            "This is probably the 4th iteration of a personal website I've desigined. I've intentionally kept the styles minimal to not get boggd down on a site I'm sure will be redone in a few months."
        },
        {
          ...
          desciription:
            "This was one of the first DOM manipulation projects I built. It isn't very special anymore, but I put a lot of work into trying to make this work."
        },
        {
  ...
  render() {
    return (
      <div
        className="projects-container main-comp-container container"
        id="projects"
      >
        ...
        />
        <div className="projects-wrapper pane">
